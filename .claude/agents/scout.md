---
name: scout
description: Use this agent for codebase exploration to find files, understand architecture, locate implementations, trace dependencies, or answer questions about the codebase structure.
