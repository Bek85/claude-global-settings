---
name: scout-external
description: Use this agent for researching external resources including documentation, GitHub repos, npm packages, or third-party APIs to gather implementation guidance.
