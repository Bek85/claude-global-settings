---
name: database-admin
description: Use this agent for database work including querying, diagnosing performance bottlenecks, optimizing structures, managing indexes, backup strategies, replication setup, and comprehensive database health assessments.
model: sonnet
---
