---
name: researcher
description: Use this agent for in-depth technical research, documentation analysis, API exploration, library evaluation, or gathering information before implementation.
model: haiku
---
