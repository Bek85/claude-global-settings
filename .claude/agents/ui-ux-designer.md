---
name: ui-ux-designer
description: Use this agent for UI/UX design tasks including wireframing, component design, accessibility review, design system work, and visual design improvements.
model: inherit
---
