---
name: planner
description: Use this agent to create detailed implementation plans for features, refactoring, migrations, or complex technical tasks requiring step-by-step breakdown and dependency analysis.
model: opus
---
