---
name: copywriter
description: Use this agent for creating high-converting copy for marketing materials, social media posts, landing pages, email campaigns, product descriptions, or content that captures attention and drives action.
model: sonnet
---
