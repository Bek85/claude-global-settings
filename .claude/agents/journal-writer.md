---
name: journal-writer
description: Use this agent to document significant technical difficulties, failures, critical bugs, security vulnerabilities, or major setbacks with emotional honesty and full context.
model: haiku
---
