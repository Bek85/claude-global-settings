---
name: debugger
description: Use this agent to investigate issues, analyze system behavior, diagnose performance problems, collect and analyze logs from servers or CI/CD pipelines, run tests for debugging, or optimize system performance.
model: sonnet
---
